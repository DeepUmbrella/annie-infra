...
```bash
ssh user@server "cd /root/annie-deploy && docker compose ps"
ssh user@server "cd /root/annie-deploy && docker compose logs --tail=100 backend"
ssh user@server "cd /root/annie-deploy && docker compose logs --tail=100 frontend"
```
